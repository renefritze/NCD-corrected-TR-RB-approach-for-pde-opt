...
if mu_est is False and mu_error is False:
    ...
    times_full_4 , J_error_4, FOC_4 = get_data(directory,method_tuple[4][0], FOC=True)
    times_full_5 , J_error_5, FOC_5 = get_data(directory,method_tuple[5][0], FOC=True)
    ...
    times_full_4 , J_error_4 , mu_error_4 , FOC_4 = get_data(directory,method_tuple[4][0] , mu_error_=mu_error, FOC=True)
    times_full_5 , J_error_5 , mu_error_5 , FOC_5 = get_data(directory,method_tuple[5][0] , mu_error_=mu_error, FOC=True)
elif mu_est is True:
    ...
    times_full_4 , J_error_4 , mu_error_4 , times_mu_4 , mu_est_4, FOC_4 = get_data(directory,method_tuple[4][0] , mu_est, mu_est, FOC=True)
    times_full_5 , J_error_5 , mu_error_5 , times_mu_5 , mu_est_5, FOC_5 = get_data(directory,method_tuple[5][0] , mu_est, mu_est, FOC=True)
    #fix mu_est_2
...
if 1:
    ...
    plt.semilogy(times_full_4 ,J_error_4 , '-', color=colorclass4 , marker='x', label=method_tuple[4][1])
    # plt.xlim([-3,3600])
    # plt.ylim([1e-18, 1e4])
...
if mu_error is True:
    ...
    plt.semilogy(times_full_5 ,mu_error_5 , '-', color=colorclass5 , marker='D', label=method_tuple[5][1])
    ...
    plt.semilogy(times_full_3 ,mu_error_3 , '-', color=colorclass3 , marker='p', label=method_tuple[3][1])
    plt.semilogy(times_full_4 ,mu_error_4 , '-', color=colorclass4 , marker='x', label=method_tuple[4][1])
    plt.xlabel('time in seconds [s]',fontsize=14)
